...
def create_appointment_view(request: HttpRequest, subscription_id: int) -> HttpResponse:
    ...
    it the Tutor related to the Subscription.
    ...
    Returns:
        ...
        object was found or not and the logged in user was the
        Tutor related to a given Subsctiprion object.
    """
    ...
    if request.method == "GET":
        if request.user != subscription.tutor.user:
            return render(
                ...
                status=403,
                context={
                    "warning_message": "You are not allowed to create Appointments.",
        ...
        Appointment.objects.create(lesson_info=lesson, subscription=subscription)
