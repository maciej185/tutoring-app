...
class Migration(migrations.Migration):
    ...
    replaces = [('profiles', '0001_initial'), ('profiles', '0002_alter_historicalprofile_teaching_since_and_more')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_pic', models.ImageField(default=pathlib.PureWindowsPath('static/default_main_pic.jpg'), upload_to=profiles.models.profile_pic_directory_path)),
                ('date_of_birth', models.DateField()),
                ('description', models.TextField()),
                ('city', models.CharField(max_length=100)),
                ('teaching_since', models.DateField(help_text="If the instance is Student's profile then this field must be Null.", null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('profile_pic', models.TextField(default=pathlib.PureWindowsPath('static/default_main_pic.jpg'), max_length=100)),
                ('date_of_birth', models.DateField()),
                ('description', models.TextField()),
                ('city', models.CharField(max_length=100)),
        ...
        migrations.AlterField(
            model_name='profile',
            name='teaching_since',
            field=models.DateField(blank=True, help_text="If the instance is Student's profile then this field must be Null.", null=True),
        ),
    ]
